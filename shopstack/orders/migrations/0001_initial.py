# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2016-08-27 21:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ordnum', models.UUIDField(default=uuid.uuid4, editable=False, unique=True)),
                ('placed', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField()),
                ('status', models.CharField(choices=[('PD', 'Pending'), ('SH', 'Shipped'), ('AR', 'Arrived'), ('CN', 'Cancelled')], default='PD', max_length=2)),
                ('billing_address', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='billing_add', to='users.Address')),
                ...
                ('payment_method', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='payment_method', to='users.PaymentMethod')),
            ],
        ),
        migrations.CreateModel(
            name='OrderItem',
            fields=[
                ...
                ('price', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='USD', max_digits=4)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='shipping_add', to='users.Address'),
        ),
    ]
